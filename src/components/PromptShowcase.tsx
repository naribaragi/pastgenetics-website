...
const PromptShowcase = () => {
  return (
    <div className="container px-4 max-w-screen-xl space-y-16">
      {/* Featured Prompts */}
      <section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
          {featuredPrompts.map((prompt) => (
            <Card key={prompt.id} className="group overflow-hidden bg-card/50 hover:bg-card/80 border-border/50 transition-all duration-300 hover:scale-105 hover:shadow-lg">
              <div className="relative">
                ...
                <Badge 
                  ...
                  variant={prompt.isVideo ? "default" : "secondary"}
                >
                  {prompt.category}
                </Badge>
              </div>
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {trendingPrompts.map((prompt, index) => (
            <Card key={index} className="p-4 bg-card/50 hover:bg-card/80 border-border/50 transition-all duration-300 hover:scale-[1.02]">
